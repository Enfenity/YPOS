...
function emitInternalEventCommitEvents(message, channelDetails) {
  switch (message.action) {
    case constants.pubSub.message.provider.action.eventCommit.created:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.CreatedEvent, message);
      break;
    case constants.pubSub.message.provider.action.eventCommit.deleted:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.DeletedEvent, message);
      break;
    case constants.pubSub.message.provider.action.eventCommit.businessAdded:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.ProviderBusinessAddedEvent, message);
      break;
    case constants.pubSub.message.provider.action.eventCommit.businessRemoved:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.ProviderBusinessRemovedEvent, message);
      break;
    default:
...
function emitInternalQueryEvents(message, channelDetails) {
  ...
  switch (message.action) {
    case constants.pubSub.message.provider.action.query.getAll:
      internalEventEmitter.emit(channelDetails.Internal.Query.GetAllEvent, message);
      break;
    case constants.pubSub.message.provider.action.query.getSingle:
