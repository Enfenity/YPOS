...
function emitInternalEventCommitEvents(message, channelDetails) {
  switch (message.action) {
    case constants.pubSub.message.customer.action.eventCommit.created:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.CreatedEvent, message);
      break;
    case constants.pubSub.message.customer.action.eventCommit.deleted:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.DeletedEvent, message);
      break;
    case constants.pubSub.message.customer.action.eventCommit.businessAdded:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.CustomerBusinessAddedEvent, message);
      break;
    case constants.pubSub.message.customer.action.eventCommit.businessRemoved:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.CustomerBusinessRemovedEvent, message);
      break;
    default:
...
function emitInternalQueryEvents(message, channelDetails) {
  internalEventEmitter.on(channelDetails.Internal.Query.GetAllCompletedEvent, function(response){
    _sendQueryCompleted(message, response, channelDetails, constants.pubSub.message.customer.action.query.getAll);
  });
  internalEventEmitter.on(channelDetails.Internal.Query.GetSingleCompletedEvent, function(response){
    _sendQueryCompleted(message, response, channelDetails, constants.pubSub.message.customer.action.query.getSingle);
  });

  switch (message.action) {
    case constants.pubSub.message.customer.action.query.getAll:
      internalEventEmitter.emit(channelDetails.Internal.Query.GetAllEvent, message);
      break;
    case constants.pubSub.message.customer.action.query.getSingle:
