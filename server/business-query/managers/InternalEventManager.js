...
function emitInternalEventCommitEvents(message, channelDetails) {
  ...
  switch (message.action) {
    case constants.pubSub.message.business.action.eventCommit.created:
      internalEventEmitter.emit(channelDetails.Internal.EventCommit.CreatedEvent, message);
      break;
    case constants.pubSub.message.business.action.eventCommit.deleted:
...
function emitInternalQueryEvents(message, channelDetails) {
  internalEventEmitter.on(channelDetails.Internal.Query.GetAllCompletedEvent, function(response){
    _sendQueryCompleted(message, response, channelDetails, constants.pubSub.message.business.action.query.getAll);
  });
  internalEventEmitter.on(channelDetails.Internal.Query.GetSingleCompletedEvent, function(response){
    _sendQueryCompleted(message, response, channelDetails, constants.pubSub.message.business.action.query.getSingle);
  });

  switch (message.action) {
    case constants.pubSub.message.business.action.query.getAll:
      internalEventEmitter.emit(channelDetails.Internal.Query.GetAllEvent, message);
      break;
    case constants.pubSub.message.business.action.query.getSingle:
